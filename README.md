...
**2026-08-29** — tracking **3,212 open remote roles** across **94 companies** (942 of them engineering roles). 1,758 postings disclose pay. **25 appeared today.**

<sub>Remote-only: 14,237 postings were collected across all locations and 22.6% of them were remote. Set `remote_only` to false in `config/settings.json` to track every location.</sub>

---

## Most-requested skills in remote engineering roles

Share of the 942 remote engineering postings that mention each skill.
...
|---:|---|---|---:|---:|
| 1 | Python | Languages | 453 | 48.1% |
| 2 | Distributed Systems | Practices | 336 | 35.7% |
| 3 | Observability | Practices | 321 | 34.1% |
| 4 | Go | Languages | 291 | 30.9% |
| 5 | Machine Learning | ML Fundamentals | 286 | 30.4% |
| 6 | Kubernetes | Infra & Cloud | 275 | 29.2% |
| 7 | AWS | Infra & Cloud | 273 | 29.0% |
| 8 | AI Agents | LLM & GenAI | 269 | 28.6% |
| 9 | LLMs | LLM & GenAI | 266 | 28.2% |
| 10 | TypeScript | Languages | 211 | 22.4% |
| 11 | GCP | Infra & Cloud | 201 | 21.3% |
| 12 | SQL | Languages | 185 | 19.6% |
| 13 | Statistics | ML Fundamentals | 175 | 18.6% |
| 14 | Azure | Infra & Cloud | 158 | 16.8% |
| 15 | Data Pipelines | Data Engineering | 150 | 15.9% |
| 16 | Terraform | Infra & Cloud | 148 | 15.7% |
| 17 | Java | Languages | 144 | 15.3% |
| 18 | CI/CD | Practices | 140 | 14.9% |
| 19 | React | Frameworks & Libraries | 115 | 12.2% |
...
| 34 | Prompt Engineering | LLM & GenAI | 46 | 4.9% |
| 35 | MCP | LLM & GenAI | 45 | 4.8% |
...
|---|---:|---|---|---:|
| Evals | +0.24 | | Distributed Systems | -1.10 |
| Machine Learning | +0.21 | | Airflow | -1.08 |
| AI Agents | +0.15 | | Go | -0.80 |
| SQL | +0.14 | | TypeScript | -0.71 |
| LLMs | +0.12 | | Observability | -0.68 |
| Snowflake / BigQuery | +0.12 | | Java | -0.60 |
| Databricks | +0.12 | | GCP | -0.44 |
| RAG | +0.07 | | Kubernetes | -0.37 |
...
571 of 942 engineering postings (61%) publish a salary range. Figures are the midpoint of the posted band.
...
<sub>Generated 2026-08-29T13:37:28+00:00 · 1 board(s) unreachable this run</sub>
