...
**Week 2026-W35** — tracking **14,256 open roles** across **122 companies** (4,505 of them engineering roles). 36.6% remote-friendly. 7,728 postings disclose pay.

---

## Most-requested skills in engineering roles

Share of the 4,505 engineering postings that mention each skill.
...
| 3 | Machine Learning | ML Fundamentals | 1,473 | 32.7% |
| 4 | LLMs | LLM & GenAI | 1,254 | 27.8% |
| 5 | Observability | Practices | 1,241 | 27.5% |
| 6 | Kubernetes | Infra & Cloud | 1,037 | 23.0% |
| 7 | AI Agents | LLM & GenAI | 1,028 | 22.8% |
...
| 25 | Snowflake / BigQuery | Data Engineering | 331 | 7.3% |
| 26 | Spark | Data Engineering | 302 | 6.7% |
| 27 | Airflow | Data Engineering | 280 | 6.2% |
...
| 36 | MLOps | Practices | 213 | 4.7% |
| 37 | Fine-tuning | LLM & GenAI | 212 | 4.7% |
| 38 | MCP | LLM & GenAI | 193 | 4.3% |
| 39 | Vector Databases | LLM & GenAI | 175 | 3.9% |
| 40 | dbt | Data Engineering | 175 | 3.9% |
...
2,745 of 4,505 engineering postings (61%) publish a salary range. Figures are the midpoint of the posted band.
...
<sub>Generated 2026-08-27T19:44:46+00:00 · 0 board(s) unreachable this run</sub>
